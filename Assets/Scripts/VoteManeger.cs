...
public class VoteManeger : MonoBehaviour
{
    ...
    // 占쏙옙표 占쏙옙占� 占쏙옙占쏙옙占싶몌옙 占쏙옙표 占싱몌옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙占쏙옙 占쏙옙킬訶占�
    // VoteRecord (占쏙옙표 占쏙옙占� 占쏙옙占쏙옙占쏙옙): Vote(占쏙옙표 占싱몌옙, 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙), 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙 占썼열
