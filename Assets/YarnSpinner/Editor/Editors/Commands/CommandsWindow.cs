namespace Yarn.Unity.Editor
{
    ...
    internal class CommandsCollection : IActionRegistration
    {
        ...
        public void AddCommandHandler(string commandName, Delegate handler) => commandRegistrations.Add(new Actions.CommandRegistration(commandName, handler));

        public void AddCommandHandler(string commandName, MethodInfo methodInfo) => commandRegistrations.Add(new Actions.CommandRegistration(commandName, methodInfo));
